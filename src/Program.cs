...
public class Program : GameWindow 
{
    ...
    /// </summary>
    string mapFilePath = "bin/maps/hruba_skala_objekty.png";
    ...
    protected override void OnLoad()
    {
        ...
        terrainMeshParts[0].Texture = new Texture2D("bin/textures/Ground023_1K-JPG/Ground023_1K-JPG_Color.jpg");
        ...
        //tree
        var (treeVert, treeTri) = ObjLoader.Load("bin/objects/LowPoly_Tree_v1.obj");
        ...
        Texture2D treeLeavesTexture = new Texture2D("bin/textures/leaves1.jpg");
        Texture2D treeTrunkTexture = new Texture2D("bin/textures/Bark014_1K-JPG/Bark014_1K-JPG_Color.jpg");
        Vector3 treeRot = new Vector3(-MathF.PI / 2, 0, 0);

        //rock
        var (rockVert, rockTri) = ObjLoader.Load("bin/objects/Rock1.obj");
        ...
        fontRenderer = new BitmapFontRenderer("bin/fonts/arial/ARIAL.TTF", 18, ClientSize.X, ClientSize.Y);
    }
    ...
    protected override void OnRenderFrame(FrameEventArgs args)
    {
        ...
        if (displayHud)
        {
            ...
            fontRenderer.DrawText($"(L) Lamp toggle: {lampMode}", 10, 50, Vector3.One * 255);
            fontRenderer.DrawText($"{lampHint}Lamp {lampStatus}", 10, 70, Vector3.One * 255);
